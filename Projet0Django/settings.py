"""
Django settings for Projet0Django project.
...
SECRET_KEY = '+f6(f&=t3a_g4$1@-7t(2l0#+ru!5vj+(9cxvfh795l1*61&43'
...
ROOT_URLCONF = 'Projet0Django.urls'
...
WSGI_APPLICATION = 'Projet0Django.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'projet0django',             # Nom de la base de données
        'USER': 'root',
        # 'PASSWORD': '12345',        
